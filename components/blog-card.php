<div class="items-center p-6 pt-2 hover:shadow-lg group block p-4 border border-gray-200 transition duration-500 transform hover:-translate-y-0.5 cursor-pointer bg-white" onClick="window.location='<?php the_permalink(); ?>';">
    <div class="w-full">
        ...
        <div class="group-hover:text-light-blue-200 leading-6 font-medium text-xs md:text-sm text-gray-600" style="vertical-align:bottom">
            <span class="self-start" style="margin-bottom: 10px;"><?php echo get_the_date(); ?></span> 
            <span class="text-gray-300 text-xl font-light ml-1 mr-1" style="margin-bottom: -10px;"> / </span> 
            <span>By <a href="#" class="prose"><?php the_author(); ?></a></span>
        </div>
    </div>
    <div class="w-full">
