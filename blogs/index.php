<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
    <div class="col-span-1 md:col-span-2 row-span-1 md:row-span-2 m-auto">
        <div class="sm:text-center lg:text-left">
            ...
            <p class="mt-3 text-sm text-gray-500 sm:mt-5 sm:text-3xl sm:max-w-xl sm:mx-auto md:mt-5 md:text-3xl lg:mx-0 italic">Software Engineer <a href="https://runcloud.io/" class="prose">@RunCloud</a></p>
            <div class="mt-5">
