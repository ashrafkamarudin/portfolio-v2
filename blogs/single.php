<div class="py-1">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="lg:text-center">
            ...
            <p class="mt-2 md:mt-5 text-4xl leading-12 lg:leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                <?php the_title() ?>
            </p>
            <h2 class="mt-2 text-sm text-pink-500 font-semibold tracking-wide uppercase leading-loose">
                <?php the_date(); ?> 
